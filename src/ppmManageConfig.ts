...
const main = () => {
  ...
  const keyTbl = ppm.setkey('^ENTER', `*maxlength 32000%%:*execute B${info.ppmID},*string p,ppm_cfgs=%%#;FDC%%:*closeppx %%n`);
  ...
  ppm.linemessage(`B${info.ppmID}`, paths, false, true);
