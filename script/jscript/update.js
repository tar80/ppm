 ...
 *
 * @arg 0 If the plugin-name is specified, run update alone
 * @arg 1 If nonzero dry run
 */

PPx.Execute('*script %sgu"ppm"\\dist\\installer.js')

// if (PPx.Extract('%*getcust(S_ppm#global:version)') === '0.93') {
//   PPx.Execute('*script %su"ppm"\\dist\\installer.ts,0')
//   PPx.Quit(1);
// }
